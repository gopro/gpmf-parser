...
| GPS9 | lat, long, alt, 2D speed, 3D speed, days since 2000, secs since midnight (ms precision), DOP, fix (0, 2D or 3D) | 32 | deg, deg, m, m/s, m/s, ,s, , | improved precision over GPS5 |
