...
| GPSU | UTC time and data from GPS | 1 | UTC format | Within the GPS5 stream |  
| GPSF | GPS Fix | 1 | none | 0 - no lock, 2 - 2D Lock, 3 - 3D lock |  
| GPSP | GPS precision | 1 | none | Within the GPS5 stream, under 300 is good |  
